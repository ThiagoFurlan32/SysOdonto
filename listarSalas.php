<?php //listarSala.php
    ...
    include 'conexao.php'; 
     ...
     if ($busca!='')
           $sql = "Select * from localizacao WHERE nome like '%" . $busca .  "%' order by nome"; 
       else $sql = "Select * from localizacao order by nome"; 
     $listaSala = $pdo->query($sql); 
?> 
   ...
   <div class="row">
        ...
        <div class="row">
            <div class="input-field">
                <form action="listarSalas.php" method="GET" id="frmBuscaSalas" class="col s12" >
                    <div class="input-field col s12">
                        <label for="lblNome" class="red-text text-red   darken-4 ">Informe a Sala: </label>
                        ...
                        <div class="input-field col m1"></div>
                          <button class="btn waves-effect teal darken-3 col m4" type="button" onclick="JavaScript:location.href='frmInsSalas.php'">Inserir Novo Registro</button>
